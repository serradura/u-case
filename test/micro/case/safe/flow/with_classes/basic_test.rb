...
module Micro::Case::Safe::Flow::WithClasses
  class BasicTest < Minitest::Test
    class Add2ToAllNumbers < Micro::Case::Safe
      attribute :numbers
    ...
    class DoubleAllNumbers < Micro::Case::Strict
      attribute :numbers
    ...
    class DoubleAllNumbersAndAdd2 < Micro::Case::Safe
      flow DoubleAllNumbers, Steps::Add2
    end

    class SquareAllNumbersAndAdd2 < Micro::Case::Safe
      flow SquareAllNumbers, Steps::Add2
    end

    class SquareAllNumbersAndDouble < Micro::Case::Safe
