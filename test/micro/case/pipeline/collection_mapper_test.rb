...
class Micro::Case::Pipeline::CollectionMapperTest < Minitest::Test
  Add2ToAllNumbers = Micro::Case::Pipeline[
    Steps::ConvertToNumbers,
    Steps::Add2
  ]

  DoubleAllNumbers = Micro::Case::Pipeline[
    Steps::ConvertToNumbers,
    Steps::Double
  ]

  SquareAllNumbers = Micro::Case::Pipeline[
    Steps::ConvertToNumbers,
    Steps::Square
  ]

  DoubleAllNumbersAndAdd2 = Micro::Case::Pipeline[
    DoubleAllNumbers,
    Steps::Add2
  ]

  SquareAllNumbersAndAdd2 = Micro::Case::Pipeline[
    SquareAllNumbers,
    Steps::Add2
  ]

  SquareAllNumbersAndDouble =
    Micro::Case::Pipeline[SquareAllNumbersAndAdd2, DoubleAllNumbers]

    DoubleAllNumbersAndSquareAndAdd2 =
    Micro::Case::Pipeline[DoubleAllNumbers, SquareAllNumbersAndAdd2]
