...
class Micro::Case::Pipeline::Safe::CompositionOperatorTest < Minitest::Test
  ...
  def test_the_error_when_using_the_regular_composition_operator
    ...
    assert_match(/undefined method `>>' for #<Micro::Case::Pipeline::SafeReducer.*>. Please, use the method `&' to avoid this error\./, err.message)
  end
end
